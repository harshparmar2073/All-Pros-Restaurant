...
const RestaurantSettings = () => {
  ...
  // Notification state – initialized to default values.
  ...
  // Fetch current settings on mount with cache disabled
  useEffect(() => {
  ...
  // Handle password change submission with API integration
  ...
  // Handle notification settings save with API integration
    ...
    <Fade in={true} timeout={500}>
      <Paper elevation={0} sx={{ p: 3 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Box sx={{ mt: 1 }}>
              <Button variant="contained" onClick={handlePasswordSubmit} sx={{ ...customButtonSx, px: 4 }}>
                Update Password
              </Button>
            </Box>
          </Grid>
  ...
  const renderNotificationSection = () => (
    <Fade in={true} timeout={500}>
      <Paper elevation={0} sx={{ p: 3 }}>
        ...
        <Box sx={{ mt: 3 }}>
          <Button variant="contained" onClick={handleNotificationSave} sx={{ ...customButtonSx, px: 4 }}>
            Save Preferences
          </Button>
        </Box>
      </Paper>
  ...
  // Render security section (static demo; integrate API calls as needed)
      ...
      <Paper elevation={0} sx={{ p: 3 }}>
        ...
        <List>
          <ListItem>
            ...
            <ListItemText primary="Email Verification" secondary="Your email has been verified" />
            <Button variant="outlined" size="small" sx={customButtonSx}>
              Change Email
            </Button>
          </ListItem>
          ...
          <ListItem>
            ...
            <ListItemText primary="Phone Verification" secondary="+1 (555) 123-4567" />
            <Button variant="outlined" size="small" sx={customButtonSx}>
              Verify
            </Button>
          </ListItem>
          ...
          <ListItem>
            ...
            <ListItemText primary="Two-Factor Authentication" secondary="Protect your account with 2FA" />
            <Button variant="outlined" size="small" color="primary" sx={customButtonSx}>
              Enable
            </Button>
          </ListItem>
        </List>
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Snackbar open={alert.open} autoHideDuration={4000} onClose={handleAlertClose} anchorOrigin={{ vertical: 'top', horizontal: 'right' }}>
        ...
        <Grid item xs={12} md={3}>
          <Paper elevation={1} sx={{ borderRadius: 1 }}>
            <List component="nav" aria-label="settings navigation">
              <ListItem button selected={activeSection === 'password'} onClick={() => setActiveSection('password')}>
                <ListItemIcon>
                  <LockOutlined />
                </ListItemIcon>
              ...
              <ListItem button selected={activeSection === 'notifications'} onClick={() => setActiveSection('notifications')}>
                <ListItemIcon>
                  <NotificationsActive />
                </ListItemIcon>
              ...
              <ListItem button selected={activeSection === 'general'} onClick={() => setActiveSection('general')}>
                <ListItemIcon>
                  <SettingsOutlined />
                </ListItemIcon>
